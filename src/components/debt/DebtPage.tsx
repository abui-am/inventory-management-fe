...
const KATA = {
  receivable: {
    ...
    kosongPesan: 'Piutang muncul dari transaksi yang dibayar lewat Utang atau Giro.',
  ...
  debt: {
    ...
    kosongPesan: 'Utang muncul dari barang masuk yang dibayar lewat Utang.',
  ...
  current_account: {
    ...
    kosongPesan: 'Utang giro muncul dari barang masuk yang dibayar lewat Giro.',
